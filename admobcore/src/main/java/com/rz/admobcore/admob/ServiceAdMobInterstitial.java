package com.rz.admobcore.admob;
...
public class ServiceAdMobInterstitial extends Service {
    ...
    public int onStartCommand(Intent argIntent, int argFlags, int argStartId) {
        ...
        System.out.println("DEBUG_PRINT_THREAD_START: " + getCurrentTime());
    ...
    public void onDestroy() {
        System.out.println("DEBUG_PRINT_THREAD_DESTROYED: " + getCurrentTime());
        stopSelf();
